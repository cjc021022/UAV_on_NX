...
def draw_boxes(img, bbox, identities=None, track_id=0,offset=(0, 0)):
    tracking_bounding_box=[0,0,0,0]
    for i, box in enumerate(bbox):
        ...
        if(id==track_id):
            tracking_bounding_box=[x1,y1,x2,y2]
    ...
    # print(tracking_bounding_box)
    return img,tracking_bounding_box
